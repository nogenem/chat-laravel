...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return USER_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GROUP_TYPE; });
var USER_TYPE = "App.User";
var GROUP_TYPE = "App.Group";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__controllers_ChatController__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_socket_io_client__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_debounce__ = __webpack_require__(86);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ChatUsersController__ = __webpack_require__(60);
...
var ChatController = function () {
  function ChatController() {
    ...
    this.chatUsersController = new __WEBPACK_IMPORTED_MODULE_3__ChatUsersController__["a" /* default */](this);
  ...
  _createClass(ChatController, [{
    ...
    value: function init() {
      ...
      this.chatRow.addEventListener("wheel", __WEBPACK_IMPORTED_MODULE_2_lodash_debounce___default()(this.onChatScroll, 150));
    ...
    value: function startEchoListeners() {
      ...
      window.Echo.private("chat." + this.userId).listen("NewMessage", function (data) {
        ...
        var fromId = msg.from;
        var fromType = __WEBPACK_IMPORTED_MODULE_4__constants__["b" /* USER_TYPE */];
        if (msg.to_type === __WEBPACK_IMPORTED_MODULE_4__constants__["a" /* GROUP_TYPE */]) {
          fromId = msg.to_id;
    ...
    key: "onChatScroll",
    value: function onChatScroll() {
      var _this3 = this;

      if (!this.loadingNextPage && this.talkingTo.next_page_url !== null && this.chatRow.scrollTop === 0) {
        this.chat.insertAdjacentHTML("afterbegin", '<li class="center red-text loading-msgs">Loading...</li>');
        this.loadingNextPage = true;

        axios.get(this.talkingTo.next_page_url).then(function (_ref) {
          var _messages;
          ...
          var lastScrollHeight = _this3.chatRow.scrollHeight;
          var lis = msgs.map(_this3.getMessageLi);

          _this3.chat.querySelector(".loading-msgs").remove();
          _this3.chat.insertAdjacentHTML("afterbegin", lis.join(""));
          _this3.chatRow.scrollTop = _this3.chatRow.scrollHeight - lastScrollHeight;

          (_messages = _this3.messages).unshift.apply(_messages, _toConsumableArray(msgs));
          _this3.talkingTo.next_page_url = resp.next_page_url;
...
/* harmony default export */ __webpack_exports__["a"] = (ChatController);
...
var ChatUsersController = function () {
  ...
  _createClass(ChatUsersController, [{
    ...
    value: function getDataAttr(id, type) {
      return type === __WEBPACK_IMPORTED_MODULE_0__constants__["b" /* USER_TYPE */] ? "data-user-id=\"" + id + "\"" : "data-group-id=\"" + id + "\"";
    }
  }]);
